              ...
              <div className="p-4">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="rounded-md bg-destructive/20 border border-destructive/40 px-4 py-2 text-sm font-medium text-destructive hover:bg-destructive/30 transition-colors cursor-pointer"
                  >
